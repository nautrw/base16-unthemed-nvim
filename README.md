# base16-unthemed-nvim
Basically [base16-nvim](https://github.com/RRethy/base16-nvim) but without the preinstalled themes.

This will heavily reduce startup times and only the themes you want need to be loaded.
